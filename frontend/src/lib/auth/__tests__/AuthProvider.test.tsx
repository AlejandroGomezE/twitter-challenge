...
import { AUTH_ME_QUERY_KEY, type SignUpCredentials } from '../auth-context'
import { useAuth } from '../use-auth'

// Sign-up's fields (a superset of sign-in's), so one fixture serves both actions.
...
function AuthConsumer() {
  ...
  const run = (action: 'signIn' | 'signUp') =>
...
const meResponds = (resolver: HttpResponseResolver) => server.use(http.get(apiUrl('/auth/me'), resolver))
