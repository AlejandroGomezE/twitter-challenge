...
import { NewPostsContext, feedQueryKey, type FeedTab } from './new-posts-store'
...
export function useNewPosts(tab: FeedTab) {
...
const keepFirstPage = (data?: PostListData): PostListData | undefined =>
...
export function useShowNewPosts(tab: FeedTab) {
  ...
  return useCallback(async () => {
    ...
    queryClient.setQueryData<PostListData>(queryKey, keepFirstPage)
