...
const ADA = { id: 'u1', email: 'ada@example.com', username: 'ada', displayName: 'Ada Lovelace' } satisfies AuthUser
...
function mockSignUp(
  respond: () => HttpResponse<DefaultBodyType> = () => HttpResponse.json(ADA, { status: 201 }),
) {
...
async function fillAndSubmit(
  user: UserEvent,
  { displayName = 'Ada Lovelace', username = 'ada', email, password, confirmPassword }: SignUpFields,
) {
