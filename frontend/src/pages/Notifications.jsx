...
function useMarkReadOnFirstPage(query) {
...
function useUnreadThisVisit(items) {
  ...
  return (item) => !item.read || unreadIds.has(item.id);
}
...
function NotificationRow({ notification, unread, me }) {
...
function NotificationsSkeleton({ count = 5 }) {
  return (
    <div aria-busy="true">
