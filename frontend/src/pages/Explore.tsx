...
const toUrlQuery = (value: string) => (value.trim() ? value : '');
...
function useExploreQuery(): [string, Dispatch<SetStateAction<string>>, string] {
...
function ExploreRow({ item, isMe }: ExploreRowProps) {
  return (
...
function ExploreSkeleton({ count = 5 }: { count?: number }) {
  return (
    <div aria-busy="true">
