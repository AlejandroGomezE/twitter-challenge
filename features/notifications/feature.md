...
- [x] `EditProfile.test.jsx` fails intermittently (1–3 tests, e.g. "sends bio \"\" when the bio is cleared"). It also fails with this feature's files removed · pre-existing, unrelated. → fixed in `fix-edit-profile-tests` (PR #14).
